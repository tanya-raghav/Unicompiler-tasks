...
############################################################################################  Labels
IntroLabel = Label(root, text='Youtube Video Downloader ', width=26, relief='ridge', bd=4,
                   font=('Arial', 40, 'italic bold'), fg='Black')
...
#####################################################################################################  Buttons
ClickButton = Button(root, text='Enter Url And Click', font=('Arial', 10, 'italic bold'), bg='white', fg='red',
